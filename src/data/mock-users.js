...
export const mockUsers = [
  {
    ...
    competencyProfile: {
      // STATISTICAL (10)
      "COMP_SURVEY_DESIGN": { currentLevel: 2, requiredLevel: 4, currentScore: 50, requiredScore: 85, gap: 35, gapStatus: "High" },
      ...
      // TECHNICAL (12)
      "COMP_PYTHON": { currentLevel: 4, requiredLevel: 4, currentScore: 82, requiredScore: 80, gap: 0, gapStatus: "Low" },
      ...
      "COMP_SAS": { currentLevel: 2, requiredLevel: 3, currentScore: 65, requiredScore: 75, gap: 10, gapStatus: "Low" },
      "COMP_GIS": { currentLevel: 2, requiredLevel: 3, currentScore: 60, requiredScore: 75, gap: 15, gapStatus: "Medium" },
      "COMP_VIZ": { currentLevel: 3, requiredLevel: 4, currentScore: 65, requiredScore: 85, gap: 20, gapStatus: "Medium" },
      "COMP_AI_ML": { currentLevel: 2, requiredLevel: 3, currentScore: 60, requiredScore: 75, gap: 15, gapStatus: "Medium" },
      "COMP_CLOUD": { currentLevel: 2, requiredLevel: 2, currentScore: 65, requiredScore: 65, gap: 0, gapStatus: "Low" },
      "COMP_APIS": { currentLevel: 2, requiredLevel: 3, currentScore: 60, requiredScore: 75, gap: 15, gapStatus: "Medium" },
  ...
  },
  {
    ...
    jobRole: "Technical / Data Analyst & Statistical Programmer",
    currentAssignment: "Automated Data Processing & Machine Learning Pipelines",
    qualification: "M.Sc. in Computer Science & Statistics",
    skills: ["Python", "SQL", "Machine Learning", "FastAPI", "Pandas", "PySpark"],
    parichayId: null,
    igotLearnerId: "IGOT-DEMO-002",
    competencyProfile: {
      "COMP_PYTHON": { currentLevel: 5, requiredLevel: 4, currentScore: 92, requiredScore: 80, gap: 0, gapStatus: "Low" },
      "COMP_SQL": { currentLevel: 4, requiredLevel: 4, currentScore: 88, requiredScore: 80, gap: 0, gapStatus: "Low" },
      "COMP_AI_ML": { currentLevel: 4, requiredLevel: 3, currentScore: 85, requiredScore: 70, gap: 0, gapStatus: "Low" },
      "COMP_SAMPLING": { currentLevel: 1, requiredLevel: 3, currentScore: 35, requiredScore: 75, gap: 40, gapStatus: "High" },
      "COMP_NATIONAL_ACCOUNTS": { currentLevel: 1, requiredLevel: 3, currentScore: 30, requiredScore: 75, gap: 45, gapStatus: "Critical" },
      "COMP_SURVEY_DESIGN": { currentLevel: 3, requiredLevel: 3, currentScore: 75, requiredScore: 75, gap: 0, gapStatus: "Low" },
      "COMP_PRICE_STATS": { currentLevel: 3, requiredLevel: 4, currentScore: 70, requiredScore: 85, gap: 15, gapStatus: "Medium" },
      "COMP_DATA_QUALITY": { currentLevel: 2, requiredLevel: 3, currentScore: 60, requiredScore: 75, gap: 15, gapStatus: "Medium" },
      "COMP_R": { currentLevel: 2, requiredLevel: 2, currentScore: 65, requiredScore: 65, gap: 0, gapStatus: "Low" },
      "COMP_GIS": { currentLevel: 2, requiredLevel: 2, currentScore: 60, requiredScore: 65, gap: 5, gapStatus: "Low" },
      "COMP_VIZ": { currentLevel: 3, requiredLevel: 3, currentScore: 75, requiredScore: 75, gap: 0, gapStatus: "Low" },
      "COMP_DATA_ANALYSIS": { currentLevel: 4, requiredLevel: 3, currentScore: 85, requiredScore: 70, gap: 0, gapStatus: "Low" },
      "COMP_CYBERSECURITY": { currentLevel: 2, requiredLevel: 2, currentScore: 60, requiredScore: 65, gap: 5, gapStatus: "Low" },
      "COMP_COMMUNICATION": { currentLevel: 2, requiredLevel: 3, currentScore: 60, requiredScore: 75, gap: 15, gapStatus: "Medium" },
      "COMP_ETHICS": { currentLevel: 3, requiredLevel: 3, currentScore: 75, requiredScore: 75, gap: 0, gapStatus: "Low" }
    },
    learningStats: {
      coursesCompleted: 5,
      coursesInProgress: 2,
